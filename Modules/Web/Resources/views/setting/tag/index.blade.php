                                            ...
                                            <tr class="item">
                                                ...
                                                <td>
                                                    <div class="ui mini basic icon buttons">
                                                        <a href="{{route('setting_tag.edit',['uuid'=>\request()->route('uuid'),'id'=>$item->id])}}"
                                                        ...
                                                        <form id="delete-form-{{$item->id}}"
                                                              action="{{route('setting_tag.destroy',['uuid'=>\request()->route('uuid'),'id'=>$item->id])}}"
                                                              method="POST"
                                                              style="display: none;">
                                                            {{ csrf_field() }}
                                                            {{method_field('DELETE')}}
